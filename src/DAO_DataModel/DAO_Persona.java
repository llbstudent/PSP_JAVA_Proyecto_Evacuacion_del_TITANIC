...
public class DAO_Persona extends ArrayList<Persona>{
	...
	private DAO_Persona() {
		...
		try {
			...
			this.add(new Pasajero("33659020P", "Fiabre Almode", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Francia, ZonaBarco.Estribor, 17));
			this.add(new Pasajero("35487121K", "Marinna Almode", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Francia, ZonaBarco.Estribor, 17));
			this.add(new Pasajero("78951020C", "Pierre Lutte", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Francia, ZonaBarco.Estribor, 17));
			this.add(new Pasajero("56326698M", "Marco Dimarck", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Francia, ZonaBarco.Estribor, 17));
			this.add(new Pasajero("54126633N", "Juan cuesta", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.España, ZonaBarco.Estribor, 18));
			this.add(new Pasajero("54552360B", "Francisco Cuesta", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.España, ZonaBarco.Estribor, 18));
			this.add(new Pasajero("02136984E", "Paloma Palomina", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.España, ZonaBarco.Estribor, 18));
			this.add(new Pasajero("01239745I", "Natalia Cuesta", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.España, ZonaBarco.Estribor, 18));
			this.add(new Pasajero("01236330O", "Valentino Malino", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Italia, ZonaBarco.Estribor, 19));
			this.add(new Pasajero("01234410P", "Mariana Malina", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Italia, ZonaBarco.Estribor, 19));
			this.add(new Pasajero("02366980L", "Constantino Capirino", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Italia, ZonaBarco.Estribor, 19));
			this.add(new Pasajero("02325410M", "Stephanie Merendi", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Italia, ZonaBarco.Estribor, 19));
			this.add(new Pasajero("02113632G", "Heidi Chapellini", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Italia, ZonaBarco.Estribor, 19));
			this.add(new Pasajero("03656632D", "Heidi Klumt", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Alemania, ZonaBarco.Estribor, 11));
			this.add(new Pasajero("45623014S", "Patrick Schue", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Alemania, ZonaBarco.Estribor, 11));
			
			this.add(new Pasajero("32556932L", "Henry Ford", false, new SimpleDateFormat("dd/MM/yyyy").parse("01/01/1995"), Pais.Alemania, ZonaBarco.Proa, 30));
			this.add(new Pasajero("31112563J", "Terrance Ford", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Alemania, ZonaBarco.Proa, 30));
			this.add(new Pasajero("32336598Y", "Phiona Ford", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Alemania, ZonaBarco.Proa, 30));
			...
			this.add(new Tripulante("14697750B", "Briggitte Reimhardt", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Alemania, ZonaBarco.Popa,  NivelResponsabilidad.media));
			this.add(new Tripulante("32459877V", "Komradt Reimhardt", false, new SimpleDateFormat("dd/MM/yyyy").parse("31/01/1995"), Pais.Alemania, ZonaBarco.Popa,  NivelResponsabilidad.media));
